...
export default function Barang({ barangs }: any) {
  // =========================
  // TABLE STATE
  // =========================
  ...
  const columns = [
    ...
    { accessorKey: 'nama_barang', header: 'Nama' },
    { 
        accessorKey: 'hpp', 
        header: 'HPP',
        cell: ({ row }: any) => formatRupiah(row.original.hpp)
    },
    { 
        accessorKey: 'harga_jual', 
        header: 'Harga Jual',
        cell: ({ row }: any) => formatRupiah(row.original.harga_jual)
    },
    { 
        accessorKey: 'margin', 
        header: 'Margin',
        cell: ({ row }: any) => formatRupiah(row.original.margin)
    },
    {
        header: 'Aksi',
        cell: ({ row }: any) => {
    ...
    <AppLayout>
      <div className="space-y-4">
        ...
        <div className="flex justify-between items-center">
          <h1 className="text-lg font-semibold text-gray-800">Master Barang</h1>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-white w-full max-w-md rounded-xl shadow-xl p-5 space-y-4">
              ...
              <div className="space-y-3 text-xs">
                {['kode_barang', 'nama_barang', 'hpp', 'harga_jual'].map((field) => (
                    <div key={field}>
                    ...
                    <input
                        type={['hpp', 'harga_jual'].includes(field) ? 'number' : 'text'}
                ...
                <div className='col-md-2'>
                    <h5 className='text-grey-200'>Komposisi</h5>
                    <table className='w-full text-[11px]'>
                        ...
                        <tfoot>
                            <br /> 
                            <button className='flex items-center gap-1 bg-blue-600 text-white px-3 py-1.5 rounded text-xs hover:bg-blue-700'>Tambah</button>
                        </tfoot>
                    </table>
                </div>
